...
class PDF_WriteTag extends FPDF
{
    ...
    function Footer()
    {
        ...
        // $this->cell(0, 10, utf8_decode('CALIDAD, EFICIENCIA Y BUEN SERVICIO'), 0, 0, 'C');

        // $this->cell(10,10, utf8_decode('Usuario: '.$_SESSION['username']),0,0,'R');
        // $this->cell(0, 10, utf8_decode('Papeleria Honduras S. de R.L.'), 0, 0, 'R');
        // $this->Ln(5);
        // $this->cell(0, 10, utf8_decode('Cel: (504) 2235-6315 / 9906-2176 '), 0, 0, 'R');
        // $this->cell(0,10, utf8_decode('Usuario: '.$_SESSION['username']),0,0,'R');
    }

    function Footer2($texto)
    {
        $this->SetY(-15);
        $this->SetFont('calibri', 'I', 8);
        $this->Ln(2);
