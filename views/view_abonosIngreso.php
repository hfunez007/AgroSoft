...
<body>
    <section class="section">
        <div class="card">
            <h3 class="card-header text-center">Detalle de Cuenta Por Pagar</h3>
            <div class="card-body">
                <div class="table-responsive">
                    <table class='table table-sm table-striped'>
                        ...
                        <tr>
                            <th class=" text-muted pr-4" scope="row"><i class="far fa-user"></i> Proveedor</th>
                            <td> <label id="lblProveedor">---</label> </td>
                        </tr>
                        <tr>
                            <th class=" text-muted pr-4" scope="row"><i class="fas fa-layer-group"></i> Tipo</th>
                            <td> <label id="lblTipo">---</label> </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-4 text-center">
                        ...
                        <input type="text" hidden="none" class="form-control" id="txtIngreID">
    ...
    <script>
        $(document).ready(function() {
            ...
            fcn_listaPagosIngreso(<?php echo $_GET["id"] ?>);
        });
    </script>
